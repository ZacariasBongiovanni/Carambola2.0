export default class Mapas extends Phaser.Scene {
    ...
    create() {
      ...
      this.add.image(120, 300, "M1").setScale(1).setInteractive()
      .on("pointerdown", () => this.scene.start("juego"));
      this.add.image(410, 300, "M2b").setScale(1).setInteractive()
      /* .on("pointerdown", () => this.scene.start("juego3")); */
      this.add.image(680, 300, "M3b").setScale(1).setInteractive()
